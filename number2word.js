...
let lastTens = ['', '', '', 'treinta', 'cuarenta', 'cincuenta', 'sesenta', 'setenta', 'ochenta', 'noventa'];
let hundreds = ['', 'cien', 'doscientos', 'trescientos', 'cuatrocientos', 'quinientos', 'seiscientos', 'setecientos', 'ochocientos', 'novecientos'];
let millions = ['', 'millón', 'billón', 'trillón', 'cuatrillón', 'quintillón', 'sextillón', 'septillón', 'octillón', 'nonillón', 'decillón', 'undecillón', 'duodecillón', 'tredecillón', 'cuatordecillón', 'quindecillón', 'sexdecillón', 'septendecillón', 'octodecillón', 'novendecillón', 'vigintillón'];
let fractions = ['', 'décimo', 'centécimos', 'milésimos', 'diezmilésimos', 'cienmilésimos', 'millonésimos', 'diezmillonésimos', 'cienmillonésimos', 'billonésimos'];
...
window.number2word = function (number) {
	...
	if (2 == number.length) {
		...
		if (1 == length && Number(number[1]) > 1) str.push(fractions[length] + 's');
		else str.push(fractions[length]);
	}
	return str.join('');
};
})();